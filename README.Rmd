...
### Overview
This package offers a functional programming style framework for scrapurrr and useful tools and tutorials to overcome common scrapurrr challenges.

### Solve common webscraping tasks in a `scrapefun()`
![](vignettes/scrapefun.svg)

Write a taylor-made `scrapefun()` that solves the challenges of your specific scrapurrr task:
