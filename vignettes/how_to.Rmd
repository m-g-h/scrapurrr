...
The extraction functions used in `do_scrape()` are supposed to return a named list. This allows to bind together multiple results row wise. Usually, this is implemented as:
